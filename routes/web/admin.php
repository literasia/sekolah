...
Route::namespace('EVoting')->group(function () {
    ...
    Route::get('/admin/e-voting/pemilihan/kelas/{id}', 'PemilihanController@getKelas')
        ->name('e-voting.pemilihan.kelas');
    ...
    Route::get('/admin/e-voting/pemilihan/hapus/{id}', 'PemilihanController@destroy')
        ->name('e-voting.pemilihan-destroy');
...
Route::namespace('Fungsionaris')
    ->name('fungsionaris.')->group(function () {
    // Pegawai
    Route::get('admin/fungsionaris/pegawai', 'PegawaiController@index')
        ->name('pegawai');
    Route::get('admin/fungsionaris/pegawai/edit/{id}', 'PegawaiController@edit')
        ->name('pegawai.edit');
    Route::post('admin/fungsionaris/pegawai', 'PegawaiController@store')
        ->name('pegawai.store');
    Route::post('admin/fungsionaris/pegawai/update', 'PegawaiController@update')
        ->name('pegawai.update');
    ...
    Route::get('admin/fungsionaris/guru/edit/{id}', 'GuruController@edit')
        ->name('guru.edit');
    Route::post('admin/fungsionaris/guru', 'GuruController@store')
        ->name('guru.store');
    Route::post('admin/fungsionaris/guru/update', 'GuruController@update')
        ->name('guru.update');
...
Route::namespace('DaftarNilai')->group(function () {
    ...
    Route::put('/admin/daftar-nilai', 'DaftarNilaiController@update')
        ->name('daftar-nilai.update');
    Route::delete('/admin/daftar-nilai', 'DaftarNilaiController@destroy')
...
Route::namespace('Kalender')->group(function () {
    ...
    Route::post('/admin/kalender/tambah', 'KalenderAkademikController@store')
        ->name('kalender.tambah-event');
    Route::post('/admin/kalender/update/{id}', 'KalenderAkademikController@update')
...
Route::namespace('Profile')->group(function(){
    ...
    Route::post('/admin/profile/update', 'ProfileController@changeProfile')
...
Route::namespace('ELearning')->group(function () {
    ...
    Route::post('/admin/e-learning/materi', 'MateriController@store')
        ->name('e-learning.materi.store');
    Route::get('/admin/e-learning/materi/{id}', 'MateriController@edit')
        ->name('e-learning.materi.edit');
    Route::post('/admin/e-learning/materi/update', 'MateriController@update')
        ->name('e-learning.materi.update');
    Route::get('/admin/e-learning/materi/hapus/{id}', 'MateriController@destroy')
        ->name('e-learning.materi.delete');

    // Kuis
    Route::get('/admin/e-learning/kuis', 'KuisController@index')
        ->name('e-learning.kuis');
    Route::post('/admin/e-learning/kuis', 'KuisController@store')
        ->name('e-learning.kuis.store');
    Route::get('/admin/e-learning/kuis/{id}', 'KuisController@edit')
        ->name('e-learning.kuis.edit');
    Route::post('/admin/e-learning/kuis/update', 'KuisController@update')
        ->name('e-learning.kuis.update');
    Route::get('/admin/e-learning/kuis/hapus/{id}', 'KuisController@destroy')
        ->name('e-learning.kuis.delete');

    // Soal
    Route::get('/admin/e-learning/soal', 'SoalController@index')
        ->name('e-learning.soal');
    Route::post('/admin/e-learning/soal', 'SoalController@store')
        ->name('e-learning.soal.store');
    Route::get('/admin/e-learning/soal/{id}', 'SoalController@edit')
        ->name('e-learning.soal.edit');
    Route::post('/admin/e-learning/soal/update', 'SoalController@update')   
        ->name('e-learning.soal.update');
    Route::get('/admin/e-learning/soal/hapus/{id}', 'SoalController@destroy')
        ->name('e-learning.soal.delete');

    // Butir Soal
    Route::get('/admin/e-learning/butir-soal', 'ButirSoalController@index')
        ->name('e-learning.butir-soal');
    Route::post('/admin/e-learning/butir-soal', 'ButirSoalController@store')
        ->name('e-learning.butir-soal.store');
    Route::get('/admin/e-learning/butir-soal/{id}', 'ButirSoalController@edit')
        ->name('e-learning.butir-soal.edit');
    Route::post('/admin/e-learning/butir-soal/update', 'ButirSoalController@update')
