...
{{-- config 1 --}}
@section('title', 'Forum Diskusi | Forum Diskusi')
@section('title-2', 'Forum Diskusi')
@section('title-3', 'Forum Diskusi')
                ...
                <div class="card-body">
                    <div class="card-block">
                        ...
                        <div class="dt-responsive table-responsive">
                            <table id="forum-table" class="table table-striped table-bordered nowrap shadow-sm">
