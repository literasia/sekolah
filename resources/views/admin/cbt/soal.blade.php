...
@include('admin.cbt.modals._tambah-soal')
...
<script type="text/javascript">
    $('document').ready(function() {
        ...
        $('#form-soal').on('submit', function (event) {
            ...
            if ($('#action').val() == 'add') {
                url = "{{ route('admin.cbt.soal.store') }}";
                text = "Data sukses ditambahkan";
            }
            if ($('#action').val() == 'edit') {
                url = "{{ route('admin.cbt.soal.update') }}";
        ...
        $('#ok_button').click(function () {
            $.ajax({
                url: '/admin/cbt/soal/hapus/'+ user_id,
                beforeSend: function () {
