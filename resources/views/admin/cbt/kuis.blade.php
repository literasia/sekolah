...
@include('admin.cbt.modals._kuis')
...
<script>
    $('document').ready(function() {
        ...
        $('#form-kuis-ku').on('submit', function (event) {
            ...
            if ($('#action').val() == 'add') {
                url = "{{ route('admin.cbt.kuis.store') }}";
                text = "Data sukses ditambahkan";
            }
            if ($('#action').val() == 'edit') {
                url = "{{ route('admin.cbt.kuis.update') }}";
        ...
        $('#ok_button').click(function () {
            $.ajax({
                url: '/admin/cbt/kuis/hapus/'+ user_id,
                beforeSend: function () {
