...
@section('describ')
    Ini adalah halaman Bank Soal untuk admin
@endsection

@section('icon-l', 'icon-home')
@section('icon-r', 'icon-home')
@section('link')
    {{ route('admin.banksoal.soal') }}
@endsection
...
@include('admin.banksoal.modals._tambah-soal')
