...
@section('describ')
    Ini adalah halaman Soal untuk guru
@endsection

@section('icon-l', 'icon-home')
@section('icon-r', 'icon-home')
@section('link')
    {{ route('guru.e-learning.soal') }}
@endsection
...
@include('guru.e-learning.modals._tambah-soal')
...
<script type="text/javascript">
    $('document').ready(function() {
        $('#order-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('guru.e-learning.soal') }}",
            },
            columns: [
            {
                data: 'DT_RowIndex',
        ...
        $('#form-soal').on('submit', function (event) {
            ...
            if ($('#action').val() == 'add') {
                url = "{{ route('guru.e-learning.soal.store') }}";
                text = "Data sukses ditambahkan";
            }

            if ($('#action').val() == 'edit') {
                url = "{{ route('guru.e-learning.soal.update') }}";
        ...
        $('#ok_button').click(function () {
            $.ajax({
                url: '/guru/e-learning/soal/hapus/'+ user_id,
                beforeSend: function () {
