...
@section('describ')
    Ini adalah halaman Materi untuk guru
@endsection

@section('icon-l', 'icon-home')
@section('icon-r', 'icon-home')
@section('link')
    {{ route('guru.e-learning.materi') }}
@endsection
...
@include('guru.e-learning.modals._materi')
...
<script>
    $(document).ready(function () {
        ...
        $('#order-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('guru.e-learning.materi') }}",
            },
            columns: [
            {
                data: 'DT_RowIndex',
        ...
        $('#form-materi').on('submit', function (event) {
            ...
            if ($('#action').val() == 'add') {
                url = "{{ route('guru.e-learning.materi.store') }}";
                text = "Data sukses ditambahkan";
            }

            if ($('#action').val() == 'edit') {
                url = "{{ route('guru.e-learning.materi.update') }}";
        ...
        $('#ok_button').click(function () {
            $.ajax({
                url: '/guru/e-learning/materi/hapus/'+ user_id,
                beforeSend: function () {
