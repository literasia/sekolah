...
@section('describ')
    Ini adalah halaman Kuis untuk guru
@endsection

@section('icon-l', 'icon-home')
@section('icon-r', 'icon-home')
@section('link')
    {{ route('guru.e-learning.kuis') }}
@endsection
...
@include('guru.e-learning.modals._kuis')
...
<script>
    $('document').ready(function() {
        $('#order-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('guru.e-learning.kuis') }}",
            },
            columns: [
            {
                data: 'DT_RowIndex',
        ...
        $('#form-kuis-ku').on('submit', function (event) {
            ...
            if ($('#action').val() == 'add') {
                url = "{{ route('guru.e-learning.kuis.store') }}";
                text = "Data sukses ditambahkan";
            }

            if ($('#action').val() == 'edit') {
                url = "{{ route('guru.e-learning.kuis.update') }}";
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                url: '/guru/e-learning/kuis/'+id,
                dataType: 'JSON',
                success: function (data) {
                    // console.log(data.pengaturan);
        ...
        $('#ok_button').click(function () {
            $.ajax({
                url: '/guru/e-learning/kuis/hapus/'+ user_id,
                beforeSend: function () {
