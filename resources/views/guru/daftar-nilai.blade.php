...
@section('describ')
Ini adalah halaman Daftar Nilai untuk guru
@endsection
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <div class="card-block">
                    <h6>Filter</h6>
                    <form id="form-daftar-nilai" action="{{route('guru.daftar-nilai')}}" method="GET">
                    ...
                    <div class="dt-responsive table-responsive">
                        <table id="order-table" class="table table-striped table-bordered nowrap shadow-sm">
                            ...
                            <tbody class="text-left">
                                ...
                                {{-- <form class="form-daftar-nilai" method="post" action="{{ route('guru.daftar-nilai.store') }}"> --}}
                                @method('POST')
                                @csrf
...
<script>
    ...
    function nilai_select(siswa_id) {
        ...
        for (i = 1; i <= total; i++) {
            ...
            $.ajax({
                url: "{{ route('guru.daftar-nilai.update') }}",
                type: "POST",
                // dataType : "JSON",
                data: {
                    _token: "{{ csrf_token() }}",
    ...
    function add_cells(number) {
        ...
        //Jika tidak
            ...
            $.ajax({
                url: "{{ route('guru.daftar-nilai.store') }}",
                type: "POST",
                dataType: "JSON",
                data: {
                    _token: "{{ csrf_token() }}",
    ...
    function remove_cells(number) {
        ...
        Swal.fire({
            ...
            $.ajax({
                url: "{{ route('guru.daftar-nilai.destroy')}}",
                type: "POST",
                dataType: "JSON",
                data: {
                    _token: '{{ csrf_token() }}',
