<div class="card">
    <div class="card-body">
    	<form id="form-add-ons" action="" method="POST" enctype="multipart/form-data">
    		<div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <div class="row mx-1 text-center">
                                    ...
                                    <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="checked class="d-block checkbox">
                                        <span><i class="fa fa-school add-ons-icon mb-2"></i></span>
                                        <p class="m-0">Sekolah</p>
                                    </div>
                                    <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="_structure" checked class="d-block checkbox">
                                        <span><i class="fa fa-user-tie add-ons-icon mb-2"></i></span>
                                        <p class="m-0">Fungsionaris</p>
                                    </div>
                                    <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="_profile" checked class="d-block checkbox">
                                        <span><i class="fa fa-book add-ons-icon mb-2"></i></span>
                                        <p class="m-0">Pelajaran</p>
                                    </div>
                                    <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="tration" checked class="d-block checkbox">
                                        <span><i class="fa fa-graduation-cap add-ons-icon mb-2"></i></span>
                                        <p class="m-0">Peserta Didik</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <div class="row mx-1 text-center">
                                	<div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="_potency" checked class="d-block checkbox">
                                        <span><i class="fa fa-clipboard-list add-ons-icon mb-2"></i></span>
                                        <p class="m-0">Absensi</p>
                                    </div>
                                    <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="hecked class="d-block checkbox">
                                        <span><i class="fa fa-swatchbook add-ons-icon mb-2"></i></span>
                                    ...
                                    <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="nce" checked class="d-block checkbox">
                                        <span><i class="fa fa-file-alt add-ons-icon mb-2"></i></span>
                                        <p class="m-0">E-Rapor</p>
                                    </div>
                                    <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="_tour" checked class="d-block checkbox">
                                        <span><i class="fa fa-map-marker-alt add-ons-icon mb-2"></i></span>
                                        <p class="m-0">Pelanggaran</p>
                                    </div>
                                     <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="n" checked class="d-block checkbox">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <div class="row mx-1 text-center">
                                	<div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="r" checked class="d-block checkbox">
                                        <span><i class="fa fa-calendar add-ons-icon mb-2"></i></span>
                                        <p class="m-0">Kalender</p>
                                    </div>
                                    <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="ement" checked class="d-block checkbox">
                                        <span><i class="fa fa-bell add-ons-icon mb-2"></i></span>
                                        <p class="m-0">Pengumuman</p>
                                    </div>
                                   
                                    <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="ce" checked class="d-block checkbox">
                                        <span><i class="fa fa-file add-ons-icon mb-2"></i></span>
                                        <p class="m-0">Import</p>
                                    </div>
                                    <div class="col-2 col-sm-2 col-md-2 my-2 p-2 card rounded card-hover">
                                        <input type="checkbox" name="" checked class="d-block checkbox">
