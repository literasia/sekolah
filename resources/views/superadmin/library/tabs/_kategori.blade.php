        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div id="add-kategori-container" class="add-container">
                    <form id="form-kategori" method="POST" action="{{ route('superadmin.library-kategori.index') }}">
                        @csrf
                        <div class="row">
                ...
                <div id="update-kategori-container" class="update-container">
                    <form id="form-kategori-update" method="POST" action="{{ route('superadmin.library-kategori.index') }}">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12">
