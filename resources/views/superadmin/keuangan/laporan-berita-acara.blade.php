		...
		<div class="container">
			<div class="row">
				<div class="col-12 text-center px-4 pt-4 pb-0">
					<h5 class="font-weight-bold mb-2" style="text-decoration: underline;">BERITA ACARA SERAH TERIMA</h5>
				</div>
			</div>

			<div class="row">
				<div class="col-12 px-0 pb-4 pt-0">
					<p>Pada Hari ini : <span></span></p>
					<p class="mb-1">Yang bertanda tangan di bawah ini :</p>
					<p class="font-weight-bold mb-1">PIHAK PERTAMA</p>
					<table>
						<tr>
							<td class="col-4 pb-2 px-0">Nama</td>
							<td class="col-1 pb-2 px-3">:</td>
							<td class="col-7 pb-2 px-0">Muslim Margolang</td>
						</tr>
						<tr>
							<td class="col-4 pb-2 px-0">Jabatan</td>
							<td class="col-1 pb-2 px-3">:</td>
							<td class="col-7 pb-2 px-0">Direktur Utama </td>
						</tr>
						<tr>
							<td class="col-4 pb-2 px-0">Alamat</td>
							<td class="col-1 pb-2 px-3">:</td>
							<td class="col-7 pb-2 px-0">Jalan Karya Kasih Komplek Mitra Duta No.8 Medan</td>
						</tr>

						<tr>
							<td class="col-6 pb-2 px-0"><p class="mt-3">Selanjutnya disebut sebagai Penyedia</p></td>
						</tr>
						<tr>
							<td class="col-6 pb-2 px-0"><p class="mb-1 font-weight-bold">PIHAK KEDUA</p></td>
						</tr>
						...
						<tr>
							<td class="col-4 pb-2 px-0">Sekolah</td>
							<td class="col-1 pb-2 px-3">:</td>
							<td class="col-7 pb-2 px-0"></td>
						</tr>
						<tr>
							<td class="col-4 pb-2 px-0">Kab/Kota</td>
							<td class="col-1 pb-2 px-3">:</td>
							<td class="col-7 pb-2 px-0"></td>
						</tr>
					</table>
					...
					<p class="mt-4">Barang Sebagaimana Disebut Diatas Telah Diterima Dalam Keadaan Baik Oleh PIHAK KEDUA , Demikian Berita Acara Serah Terima Ini Dibuat Dengan Sebenarnya Untuk Dapat Dipergunakan Sebagaimana Mestinya.</p>
				</div>
			</div>
			...
			<div class="row mt-3">
				<table class="table">
					...
					<tr>
						<td class="col-4 pb-0"><div class="pr-1 pb-3" style=" margin-top: 3rem; border-bottom: 3px solid #000;"><!-- nama penerima --></div></td>
						<td class="col-4"></td>
						<td class="col-4 pb-0"><div class="pl-1 pb-3 text-center" style=" margin-top: 3rem; border-bottom: 3px solid #000;">Muslim Syah Margolang</div></td>
					</tr>
				</table>
			</div>
			...
			<div class="row">
				<table class="table">
					<tr>
						<td class="col-4 pt-2">NIP</td>
						<td class="col-4"> </td>
						<td class="col-4 pt-2 text-center">Direktur Utama</td>
					</tr>
				</table>
			</div>
