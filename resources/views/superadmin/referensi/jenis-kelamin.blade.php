...
@section('title', 'Referensi | Jenis Kelamin')
@section('title-2', 'Jenis Kelamin')
@section('title-3', 'Jenis Kelamin')
@section('describ')
    Ini adalah halaman jenis kelamin untuk superadmin
@endsection
@section('icon-l', 'icon-people')
@section('icon-r', 'icon-home')
@section('link')
    {{ route('superadmin.referensi.jenis-kelamin') }}
@endsection
